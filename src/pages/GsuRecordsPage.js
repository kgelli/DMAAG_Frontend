...
export function GsuRecordsPage() {
  ...
  const columns = [
    ...
    { key: 'seller_administrator_guardian', label: 'Legal Ward Guardian' },
    { key: 'seller_administrator_guardian_firstname', label: 'Legal Ward First Name' },
    { key: 'seller_administrator_guardian_lastname', label: 'Legal Ward Last Name' },
